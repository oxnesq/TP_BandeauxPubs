...
public class ExempleDeScenario {
    ...
    public static void main(String[] args) {
        ...
        s.addEffect(new RandomEffect(message, 50), 1);
        s.addEffect(new Zoom("Je zoome", 100), 1);
        s.addEffect(new Rotate("2 tours à droite", 180, 700, true), 2);
        /*s.addEffect(new TeleType("Je m'affiche caractère par caractère", 1), 1);
